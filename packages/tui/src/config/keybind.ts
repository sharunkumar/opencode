...
export const Definitions = {
  ...
  session_toggle_timeouts: keybind("none", "Toggle default shell timeouts"),
...
export const CommandMap = {
  ...
  session_toggle_timeouts: "session.toggle.timeouts",
  ...
  prompt_interrupt_submit: "prompt.interrupt_submit",
